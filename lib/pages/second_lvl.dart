...
class SecondLvlField extends StatefulWidget {
  @override
  State<SecondLvlField> createState() => _SecondFieldState();
}

class _SecondFieldState extends State<SecondLvlField> {
  List<int> numbers = [];
  ...
  @override
  void initState() {
    numbers = creteListNumOfBut(32);
    randNumbers = creatListShowNum(32);
    start = true;
    super.initState();
  }
      ...
      child: Center(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: heightAdaptive(20, context)),
            Container(
              height: heightAdaptive(533, context),
              width: widthAdaptive(268, context),
              child: Wrap(
                children: [
